...
class ForegroundPlugin {
  ...
  constructor(context: CallContext, names: string[], modules: { guestType: string, module: WebAssembly.WebAssemblyInstantiatedSource}[]) {
...
export async function createForegroundPlugin(
  ...
  const modules = await Promise.all(sources.map(async (source, idx, all) => {
    ...
    const guestType = (
      module.instance.exports._initialize ? 'reactor' :
      module.instance.exports.hs_init ? 'haskell' :
      module.instance.exports.__wasm_call_ctors ? 'command' :
      'none'
    );

    const init: any = (
      module.instance.exports._initialize ? module.instance.exports._initialize :
      module.instance.exports.hs_init ? module.instance.exports.hs_init :
      module.instance.exports.__wasm_call_ctors ? module.instance.exports.__wasm_call_ctors :
      () => {}
    );
